...
window.onload = () => {
  // Add textarea at the beginning of the app
  ...
  // Teaxtarea will be in focus
  textarea.focus();

  // Adding my text after my keyboard
  const myText = document.createElement('p');
  myText.innerHTML = 'ATTENTION! A useful tip: To change the language press fn.<br>This keyboard is written almost accordingly with Mac\'s keys.<br> I still decided to delete some keys I usually don\'t interact with.';
